...
const dict = {
  en: {
    ...
    category: "Category", uncategorized: "Uncategorized", noCategory: "No category",
    injection: "Injection", syrup: "Syrup", ointment: "Ointment", ampoule: "Ampoule", tube: "Tube",
  ...
  ar: {
    ...
    category: "الفئة", uncategorized: "بدون فئة", noCategory: "بدون فئة",
    injection: "حقنة", syrup: "شراب", ointment: "مرهم", ampoule: "أمبول", tube: "أنبوبة",
